...
function EditItem() {
  ...
  const {itemId}=useParams()
   ...
   const [loading,setLoading]=useState(false)
    const categories = ["Clothing", "Footwear", "Accessories", "Jewelry", "Bags", "Beauty", "Others"];
  ...
  handleGetItemById()
    ...
    setSize(Array.isArray(currentItem?.size) ? currentItem.size.join(", ") : currentItem?.size || "");
            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                <div className='flex flex-col items-center mb-6'>
                    <div className='bg-orange-100 p-4 rounded-full mb-4'>
                        {/* Fashion icon can be added here */}
                    </div>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder='Enter Brand' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
                    ...
                    <div>
                        ...
                        <input type="text" placeholder='Enter Size(s), comma separated' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
                    ...
                    <div>
                        ...
                        <input type="text" placeholder='Enter Color' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
                    ...
                    <div>
                        ...
                        <textarea placeholder='Enter Description' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
