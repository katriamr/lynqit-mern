        ...
        <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>Join our ecommerce platform and reach thousands of customers every day.
              </p>
...
<FaPen size={20}/>
          ...
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <FaUtensils className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4' />
              <h2 className='text-xl sm:text-2xl font-bold text-gray-800 mb-2'>Add Your Product</h2>
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>Share your products with our customers by adding them to your catalog.
              </p>
