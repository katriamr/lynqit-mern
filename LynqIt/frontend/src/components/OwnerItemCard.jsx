...
<p><span className='font-medium text-gray-70'>Brand:</span> {data.brand}</p>
<p><span className='font-medium text-gray-70'>Size:</span> {Array.isArray(data.size) ? data.size.join(', ') : data.size}</p>
<p><span className='font-medium text-gray-70'>Color:</span> {data.color}</p>
{data.description && <p><span className='font-medium text-gray-70'>Description:</span> {data.description}</p>}
          </div>
